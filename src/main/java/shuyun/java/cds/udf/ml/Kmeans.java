...
@Description(name = "kmeans",
        value = "_FUNC_(points, K, max_iterations) - Perform K-means clustering on a collection " +
                "of points represented as arrays and returns an array of cluster centers.")
public class Kmeans extends UDF {
