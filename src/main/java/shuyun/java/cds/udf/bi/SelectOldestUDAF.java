...
public class SelectOldestUDAF extends UDAF{
    public static class SelectLatestUDAFEvaluator implements UDAFEvaluator {
        private SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        private SelectOldestUDAF.SelectLatestUDAFEvaluator.PartialResult partialResult;
        ...
        public boolean iterate(String col, String com) {
            if(col != null && com != null) {
                if(this.partialResult == null) {
                    this.partialResult = new SelectOldestUDAF.SelectLatestUDAFEvaluator.PartialResult();
        ...
        public SelectOldestUDAF.SelectLatestUDAFEvaluator.PartialResult terminatePartial() {
            return this.partialResult;
        }

        public boolean merge(SelectOldestUDAF.SelectLatestUDAFEvaluator.PartialResult other) {
            if(other == null) {
                return true;
            } else {
                if(this.partialResult == null) {
